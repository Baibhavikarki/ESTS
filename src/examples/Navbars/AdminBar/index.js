...
import AdminBarMobile from "./AdminBarMobile";

// Material Kit 2 React base styles
import breakpoints from "../../../assets/theme/base/breakpoints";

function AdminBar({ brand, routes, transparent, light, action, sticky, relative, center }) {
  ...
  useEffect(() => {
    // A function that sets the display state for the AdminBarMobile.
    ...
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      ...
      >
        ...
        <MKBox
          ...
          px={transparent ? 2 : 0}
        >
          {mobileView && <AdminBarMobile routes={routes} open={mobileNavbar} />}
        </MKBox>
      </MKBox>
      {dropdownMenu}
      {nestedDropdownMenu}
...
// Setting default values for the props of AdminBar
...
// Typechecking props for the AdminBar
AdminBar.propTypes = {
